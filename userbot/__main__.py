...
try:
    ...
    kyyblacklist = requests.get(
        "https://raw.githubusercontent.com/Sansanzt/Sansanztblack/master/Sansanztblacklist.json"
    ).json()
...
LOGS.info(
    f"★Sansanzt-Userbot★ ⚙️ V{BOT_VER} [TELAH DIAKTIFKAN!]")


async def check_alive():
    try:
        if BOTLOG_CHATID != 0:
            await bot.send_message(BOTLOG_CHATID, "★ **Sansanzt Userbot Berhasil Diaktifkan**!!\n━━━━━━━━━━━━━━━\n➠ **Userbot Version** - 3.1.0@Sansanzt-Userbot\n➠ **Ketik** `.ping` **Untuk Mengecheck Bot**\n━━━━━━━━━━━━━━━\n➠ **Powered By:** @SansanztProject ")
    except Exception as e:
        LOGS.info(str(e))
    try:
